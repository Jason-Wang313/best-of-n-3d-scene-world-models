...
\begin{proposition}[Sparse-view Best-of-N amplification]
...
probability $p>0$, then the probability that naive Best-of-N sees at least one
such candidate is $1-(1-p)^N$.
\end{proposition}
